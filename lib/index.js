var datadogMetrics = require('datadog-metrics');

datadogMetrics.init({});

module.exports = function (options) {
	var datadog = options.dogstatsd || datadogMetrics;
	...
	return function (req, res, next) {
		...
		res.end = function (chunk, encoding) {
			...
			datadog.histogram(stat + '.response_time', (new Date() - req._startTime), statTags);
		};
